                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          ContainIcon(0, "Singaraja", Icons.my_location, Colors.orangeAccent),
                          ContainIcon(
                              12, "Reggea", Icons.music_note, Colors.purpleAccent),
                        ],
                      ),
                      Column(
                        children: <Widget>[
                          ContainIcon(0, "Anturan", Icons.home,
                              Colors.redAccent),
                          ContainIcon(12, "Undiksha", Icons.school, Colors.blue),
                        ],
                      ),
                    ],
                  ),
